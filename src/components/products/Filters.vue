    ...
    <b-list-group class="mt-4">
      <filter-accordion>
        ...
        <b-row slot="body">
          <b-col cols="6">
            <div
              :class="{ 'filter-item': true, active: brands.length === 0 }"
              @click="clearBrands"
            >
              All
            </div>
      ...
      <filter-accordion>
        ...
        <b-row slot="body">
          <b-col cols="6">
            <div
              :class="{ 'filter-item': true, active: colours.length === 0 }"
              @click="clearColours"
            >
              All
            </div>
          ...
          <b-col cols="6" v-for="item in filters.colours" :key="item">
            <div
              :class="{
                'filter-item': true,
                active: colours.indexOf(item) > -1
              }"
              @click="filterColour(item)"
            >
              {{ item }}
            </div>
          </b-col>
      ...
      <filter-accordion>
        ...
        <b-row slot="body">
          <b-col cols="6">
            <div
              :class="{ 'filter-item': true, active: os.length === 0 }"
              @click="clearOS"
            >
              All
            </div>
          ...
          <b-col cols="6" v-for="item in filters.os" :key="item">
            <div
              :class="{ 'filter-item': true, active: os.indexOf(item) > -1 }"
              @click="filterOS(item)"
            >
              {{ item }}
            </div>
      ...
      <filter-accordion>
        ...
        <b-row slot="body">
          <b-col cols="6">
            <div
              :class="{ 'filter-item': true, active: features.length === 0 }"
              @click="clearFeatures"
            >
              All
            </div>
          ...
          <b-col cols="6" v-for="item in filters.features" :key="item">
            <div
              :class="{
                'filter-item': true,
                active: features.indexOf(item) > -1
              }"
              @click="filterFeature(item)"
            >
              {{ item }}
            </div>
          </b-col>
